    ...
    return (
        <nav className={`${s.nav} ${s.scroll_bar}`}>
            <div className={s.nav_widget}>
                ...
                <ul>
                <li>
                    <NavLink to='/profile' className={s.nav_widget_btn} activeClassName={s.activeLink}>Profile</NavLink>
                </li>
                <li>
                    <NavLink to='/dialogs' className={s.nav_widget_btn} activeClassName={s.activeLink}>Messages</NavLink>
                </li>
                <li>
                ...
                <li>
                    <NavLink to='/settings' className={s.nav_widget_btn} activeClassName={s.activeLink}>Settings</NavLink>
                </li>
                </ul>
            </div>
        </nav>
